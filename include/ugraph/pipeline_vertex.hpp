...
namespace ugraph {
    ...
    template<
        ...
        typename data_t
    >
    struct PipelineVertex : ugraph::Vertex<id, meta_type> {
        ...
        struct Port {
            constexpr Port(PipelineVertex& vertex) :
                mVertex(vertex) {}
            static constexpr auto index() { return _index; }
            using vertex_type = PipelineVertex;
            PipelineVertex& mVertex;
        };

        template<std::size_t index>
        struct OutputPort : Port<index> {
            constexpr OutputPort(PipelineVertex& vertex) :
                Port<index>(vertex) {}
        ...
        constexpr PipelineVertex(meta_type& impl) : mImpl(impl) {}
